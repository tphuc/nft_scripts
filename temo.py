...
mypath = 'NFTs/prime_pattern/images/'
...
def render(id):
    ...
    # Save
    bpy.data.images['Render Result'].save_render(filepath= mypath + str(id) + ".png")
